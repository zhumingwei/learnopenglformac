...
int genTexture(const char *spath, const bool isPng = false);
...
int main(){
    ...
    unsigned char *data;
    texture1 = genTexture("opengl/textures/container.jpg",false);
    texture2 = genTexture("opengl/textures/awesomeface.png",true);
    // // texture 2
    // // ---------
